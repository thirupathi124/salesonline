        ...
        <div className="saree-layout">
            ...
            <div className="saree-main">
                <div className="saree-flex">
                    ...
                    <h3 className="saree-cloth">Sarees &amp; Blouses</h3>
                    ...
                    <div className="saree-list-item">
                        ...
                        {showsaree &&
                            (
                                <div>
                                    <p>Kurtas</p>
                                    <p className="style">Sarees &amp; Blouses</p>
                                    <p  >Dresses</p>
                                    <p>Kurtis</p>
                                    <p>Tunic Tops</p>
                        ...
                        <div className="arrow-flex">
                            <h3 onClick={() => setShowSize((prevState) => !prevState)} className="cata">Size</h3>
                            <img className="arrow-align" onClick={() => setShowSize((prevState) => !prevState)} src={ArrowDown} alt="logo" />
                        ...
                        {rangeSize && (
                            <div className="range">
                                <p> 10% and Above</p>
                                <p> 20% and Above</p>
                                <p className="range-dot" onClick={() => setShowPay(true)}> 30% and Above</p>
                                <p> 40% and Above</p>
                                <p> 50% and Above</p>
                        ...
                        <div className="saree-grid-flex">
                            ...
                            (
                                <div key={index} className="saree-desing">
                                    ...
                                    <img className="logo-width" src={item.img} alt="logo" />
